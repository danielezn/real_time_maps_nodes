...
define('PASSWORD_MYSQL','realflight'); //la clave para conectar
define('BASE_DATOS','blog'); // indica el nombre de la base de datos que contiene la tabla de los usuarios
